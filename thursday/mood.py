...
ACTIVITIES = {
    ...
    "make_plan": "working out how to do this",
    "start_step": "starting the next step",
    "finish_step": "finishing that step",
    "skip_step": "skipping a step",
    "fail_step": "noting what went wrong",
    "add_plan_step": "adding a step to the plan",
    "show_plan": "checking where we got to",
    "abandon_plan": "dropping the plan",
    "watch_for": "setting up a watch on that",
    "list_watches": "checking what I am keeping an eye on",
    "stop_watching": "letting that one go",
    "check_watches_now": "taking a look at everything I watch",
    ...
    "vault_search": "looking through your vault",
    "vault_read": "reading one of your notes",
    "vault_related": "seeing what else you know about this",
    "vault_map": "looking at the shape of your vault",
    "vault_write": "writing that into your vault",
    "vault_journal": "adding that to today's note",
    "vault_connect": "joining up what you know",
