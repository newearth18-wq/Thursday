 ...
 *   migration    — applies a slow migration list and waits to be killed while
 *                  migration 3 is half-applied.
 */
...
if (mode === 'transaction') {
  ...
  // Signal the parent right before the slow migration starts, then keep it busy long enough to be killed.
